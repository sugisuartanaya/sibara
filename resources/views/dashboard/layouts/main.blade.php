...
<html lang="en">
  ...
  <body>
    ...
    <link rel="stylesheet" type="text/css" href="https://kejari-denpasar.kejaksaan.go.id/assets/css/jquery.contactus.min.css">
    <style>
    ...
    <script>
        window.addEventListener('load', function(){
            $('#contact').contactUs({
                ...
                theme: '#008749',
                items: [{
                            title: 'Call Center Admin SIPBARAN',
                            icon: "<i class='fa fa-whatsapp'></i>",
                            href: 'https://api.whatsapp.com/send?phone=6287796384230',
                            color: '#4EB625'
                        }]
            });
        });
